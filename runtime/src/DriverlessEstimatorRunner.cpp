...
namespace runtime
{
using estimation::EstimatorEvent;
using estimation::GssMeasurement;
using estimation::GssMeasurementEigen;
using estimation::ImuMeasurement;
using estimation::InternalEstimatorState;
using estimation::LatestEstimate;
using estimation::StateCovariance;
using estimation::StateEstimate;
using estimation::StateIndex;
namespace
{
                                                  ...
                                                  bool publish_full_telemetry)
{
    ...
    if (should_publish_static_transforms)
    {
        ...
        core::publish_transform("base_link", "lidar", estimate.timestamp_ns,
                                _transform_buffer->base_to_lidar(), 0.55);
