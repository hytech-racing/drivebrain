...
constexpr int NAV_ESTIMATOR_ZERO_VEL_UPDATE_SIZE = 2;
...
class NavEstimator {
    public: 
        ...
        /**
         * Performs a zero-velocity update on the navigation estimator.
         * This is typically used when the vehicle is known to be stationary.
         */
        void zero_velocity_update();

        /**
         * Returns the current state of the navigation estimator.
         */
        NavEstimatorState get_state() const {
            return _nav_estimator_state;
        }

        /**
         * Returns the current state vector of the navigation estimator.
         * @return The current state vector.
         */
        nav_state_vector getEstimates() const {
            return _state;
        }
